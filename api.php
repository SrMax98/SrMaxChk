...
$lista = str_replace(array(" "), '/', $_GET['lista']);
  ...
  die('<span class="text-danger">Reprovada</span> ➔ <span class="text-white">'.$lista.'</span> ➔ <span class="text-danger"> Lista inválida. </span> ➔ <span class="text-warning">@SrMAX</span><br>');
  }
...
die('<span class="text-danger">Erros</span> ➔ <span class="text-white">'.$lista.'</span> ➔ <span class="text-danger"> Cookies não detectado, entre em minha conta e depois segurança e insira sua senha para ver se volta a funcionar. </span> ➔ Tempo de resposta: (' . (time() - $time) . 's) ➔ <span class="text-warning">@SrMAX</span><br>');
...
die('<span class="text-danger">Erros</span> ➔ <span class="text-white">'.$lista.'</span> ➔ <span class="text-danger"> Conta sem endereço, adicione um endereço na conta antes de fazer os testes. </span> ➔ Tempo de resposta: (' . (time() - $time) . 's) ➔ <span class="text-warning">@SrMAX</span><br>');
...
die('<span class="text-success">Aprovada</span> ➔ <span class="text-white">'.$lista.' '.$infobin.'</span> ➔ <span class="text-success"> Cartão vinculado com sucesso. ('.$err.') </span> ➔ Tempo de resposta: (' . (time() - $time) . 's) ➔ <span class="text-warning">@SrMAX</span><br>');
...
die('<span class="text-danger">Reprovada</span> ➔ <span class="text-white">'.$lista.' '.$infobin.'</span> ➔ <span class="text-danger"> Cartão inexistente. ('.$err.') </span> ➔ Tempo de resposta: (' . (time() - $time) . 's) ➔ <span class="text-warning">@SrMAX</span><br>');
...
die('<span class="text-danger">Erros</span> ➔ <span class="text-white">'.$lista.'</span> ➔ <span class="text-danger"> Erro ao realizar requisição na Amazon. </span> ➔ Tempo de resposta: (' . (time() - $time) . 's) ➔ <span class="text-warning">@SrMAX</span><br>');
